    ...
    class DL_Page_Scroll
    {
        ...
        public function _settings_page($element) {
            ...
            if ( 'section' === $element->get_name() && $dl_onepage_enable == 'yes') {
                $element->start_controls_section(
                    'dl_onepage_section',
                    [
                        'label' => __( 'One Page Scroll', 'droit-addons-pro' ) . dl_get_icon() ,
                ...
                $element->add_control(
                    ...
                    [
                        'label' => __( 'Enable Scroll', 'droit-addons-pro' ),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => __( 'Anchor ID', 'droit-addons-pro' ),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => __( 'Anchor Name', 'droit-addons-pro' ),
                        'type' => \Elementor\Controls_Manager::TEXT,
                        'default' => '',
        ...
        public function _settings( $page  ){
            ...
            $page->start_controls_section(
                'dl_onepage_settings',
                [
                    'label' => __( 'Full Screen Slider Settings', 'droit-addons-pro' ) . dl_get_icon(),
            ...
            $page->add_control(
                'dl_onepage_enable',
                [
                    'label' => __( 'Display Scroll', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Display Navigation', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Navigation Position', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'options' => [
                        'left' => __( 'Left', 'droit-addons-pro' ),
                        'right' => __( 'Right', 'droit-addons-pro' ),
                    ],
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Auto Scroll', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'ScrollBar', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $page->add_control(
                'dl_onepage_overflow',
                [
                    'label' => __( 'Overflow Scroll', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Animate Anchor', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Animate Css3', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Verticla Center', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'LazyLoading', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Menu options', 'droit-addons-pro' ),
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Enable Menu', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => __( 'On', 'droit-addons-pro' ),
                    'label_off' => __( 'Off', 'droit-addons-pro' ),
                    'return_value' => 'yes',
            ...
            $repeater->add_control(
                'dlmenu_title', [
                    ...
                    'type' => \Elementor\Controls_Manager::TEXT,
                    'default' => __( 'Menu Title' , 'droit-addons-pro' ),
                    'label_block' => true,
                ]
            );
            $repeater->add_control(
            ...
            $page->add_control(
                'dl_onepage_menus',
                [
                    'label' => __( 'Menus', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::REPEATER,
                    'fields' => $repeater->get_controls(),
                    'default' => [
                        [
                            'dlmenu_title' => __( 'Section 1', 'droit-addons-pro' ),
                            'dlmenu_id' => 'section1',
                        ],
            ...
            $page->add_control(
                ...
                [
                    'label' => __( 'Preview & Next Button', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            $page->add_control(
                'dl_onepage_toggle_preview', [
                    'label' => __( 'Preview Text', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::TEXT,
                    'default' => __( 'Preview' , 'droit-addons-pro' ),
                    'label_block' => true,
                ]
            );
            $page->add_control(
                'dl_onepage_toggle_next', [
                    'label' => __( 'Next Text', 'droit-addons-pro' ),
                    'type' => \Elementor\Controls_Manager::TEXT,
