...
class Widgets_Loader{
    ...
    public static function widget_map() {
        ...
        return apply_filters('drth_elementor_widgets_loading', [
            ...
            'testimonials' => [
	            'title' => __( 'Testimonials', 'fabio-core' ),
	            'js' => [''],
	            'css' => [''],
	            'source' => 'local',
            ],
            ...
            'experience' => [
	            'title' => __( 'Experience', 'fabio-core' ),
	            'js' => [''],
	            'css' => [''],
	            'source' => 'local',
            ],
