    ...
    */
    public function render_style_section() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '.drdt-nav-menu .menu>.nav-item>.nav-link' => 'color: {{VALUE}};'
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '.drdt_navmenu > li > a' => 'background: {{VALUE}};'
                ],
            ]
        );
	    ...
	    $this->add_group_control(
		    ...
		    [
			    ...
			    'selector' => '{{WRAPPER}} .drdt_navmenu li a',
		    ]
	    );
	    $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '.drdt_navmenu li a:hover' => 'color: {{VALUE}};'
                ],
            ]
        );
	    $this->add_control(
		    ...
		    [
			    ...
			    'type' => Controls_Manager::COLOR,
			    'selectors' => [
				    '.drdt_navmenu li a:hover' => 'background: {{VALUE}};'
			    ],
		    ]
	    );
	    $this->add_group_control(
		    ...
		    [
			    ...
			    'label' => __( 'Text Shadow', 'droithead' ),
			    'selector' => '{{WRAPPER}} .drdt_navmenu li a:hover',
		    ]
	    );
	    $this->add_group_control(
		    Group_Control_Box_Shadow::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'after'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '.drdt-header .drdt_menu_fixed .drdt-nav-menu__layout-horizontal:not(.drbt_menu_active) .drdt_navmenu > .menu-item > .drdt-menu-item' => 'color: {{VALUE}};',
                    '.drdt-header .drdt_menu_fixed .drdt-nav-menu__layout-horizontal:not(.drbt_menu_active) .drdt_navmenu > .menu-item > .drdt-has-submenu-container > .drdt-menu-item' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '.drdt-header .drdt_menu_fixed .drdt-nav-menu__layout-horizontal:not(.drbt_menu_active) .drdt_navmenu > .menu-item:hover > .drdt-menu-item' => 'color: {{VALUE}};',
                    '.drdt-header .drdt_menu_fixed .drdt-nav-menu__layout-horizontal:not(.drbt_menu_active) .drdt_navmenu > .menu-item:hover > .drdt-has-submenu-container > .drdt-menu-item' => 'color: {{VALUE}};',
                    '.drdt-header .drdt_menu_fixed .drdt-nav-menu__layout-horizontal:not(.drbt_menu_active) .current-menu-parent.active > .drdt-has-submenu-container > .drdt-menu-item' => 'color: {{VALUE}};',
                    '.drdt-header .drdt_menu_fixed .drdt-nav-menu__layout-horizontal:not(.drbt_menu_active) .current-menu-item .active' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li ul li a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li ul li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'after',
            ]
        );
        $this->add_group_control(
            ...
            [
                'name' => 'border',
                'label' => __( 'Border', 'droithead' ),
                'selector' => '{{WRAPPER}} .drdt_navmenu li ul li a',
            ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'selector' => '
                    {{WRAPPER}} .drdt_navmenu li ul li a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li ul li a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li ul li a' => 'color: {{VALUE}};',
                ],
            ]
        );
        /* $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li ul li a' => 'background: {{VALUE}};',
                ],
            ]
        ); */
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li ul li a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .drdt_navmenu li ul li a:hover' => 'background: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $args = [
			'echo'        => false,
			'menu'        => $drdt_menus,
			'menu_class'  => 'drdt_navmenu menu',
			'menu_id'     => 'menu-' . $this->get_menu_index() . '-' . $this->get_id(),
			'fallback_cb' => '__return_empty_string',
			'container'   => '', 
        ];
        if(class_exists('\Medishop_Navwalker')) {
            $args['walker'] = new \Medishop_Navwalker();
        }
